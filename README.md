<div align="center">
  ...
  <p>
    <a href="https://jsb.betterjxnu.cn/"><img src="https://img.shields.io/badge/%E5%AE%98%E7%BD%91-jsb.betterjxnu.cn-A91D34" alt="官网"></a>
...
课程周次修改按学期分别保存，同名课程不会跨学期互相影响。离线缓存可查看；编辑周次需要先联网加载课表。升级时旧周次设置会迁移到已有课表快照对应的学期，无法确定归属的旧设置需在相应学期重新编辑。
...
Android 8.0 以上，从[官网](https://jsb.betterjxnu.cn/)或 [Releases](../../releases) 下载 APK——两边是同一个包，官网页面标注了 SHA-256 可自行校验。
